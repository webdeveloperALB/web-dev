...
const Social = () => {
  return (
    <div className="card">
      ...
      >
        <svg className="socialSvg instagramSvg" viewBox="0 0 16 16" aria-hidden="true">
      ...
      >
        <FaFacebook className="h-4 w-4 text-white" aria-hidden="true" />
      ...
      >
        <svg className="socialSvg linkdinSvg" viewBox="0 0 448 512" aria-hidden="true">
